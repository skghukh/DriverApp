...
public class VehicleController {
	...
	public ResponseEntity<?> saveVehicle(@PathVariable("driver_id") long driverId,
			@RequestParam(value = "number") String number, @RequestParam(value = "vehicletype_id") long typeId,
	...
	private ResponseEntity<?> addVehicle(long driverId, String number, long typeId, String ownerFirstName,
		...
		if (null == driver) {
			jsonResponse.setMessage("Driver doesn't exist");
